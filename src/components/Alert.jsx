...
const Alert = ({status, alertMsg}) => {
  return (
    ...
    <motion.div {...slideUpOut} className='fixed top-24 right-12 z-10'>
        ...
        {status ==="Warning" && (
            <div className='px-4 py-2 rounded-md bg-yellow-500 shadow-md shadow-emerald-500'>
                <p className='text-lg text-primary '>
                    {alertMsg}
                </p>
            </div>
        ...
        {status ==="Danger" && (
            <div className='px-4 py-2 rounded-md bg-red-500 shadow-md shadow-emerald-500'>
                <p className='text-lg text-primary '>
                    {alertMsg}
                </p>
            </div>
